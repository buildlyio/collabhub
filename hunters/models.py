...
class Hunter(models.Model):
    ...
    location = models.CharField(max_length=255, blank=True, help_text="Geographic Location of Position")
    remote = models.CharField(max_length=255, blank=True, help_text="Remote, In-Office or Hybrid")
    language = models.CharField(max_length=255, blank=True, help_text="Langugae Requirements (English, Spanish Etc.)")
